...
class Decoder
{
     ...
     * {@link Aegis\JSON\JSON::TYPE_ARRAY} and {@link Aegis\JSON\JSON::TYPE_OBJECT} for
     * valid values
     ...
     * either or {@link Aegis\JSON\JSON::TYPE_ARRAY} or
     * {@link Aegis\JSON\JSON::TYPE_OBJECT}; defaults to TYPE_ARRAY
     * @return mixed
     */
     ...
     *
     * If Aegis\JSON\Encoder was used to encode the original object then
